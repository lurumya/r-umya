...
soit la réponse me paraissait tellement évidente que je n'ai pas vérifié (donc problématique)
=====================================================================================
*/
...
var_dump(1 . 2) ; ; // le "." veut dire concaténation. Donc ça donne : (int)12
...
// Exemple : $str = 'salut'; echo '$str' affichera '$str', alors que echo "$str" afficher salut.
// Je ne comprends pas très bien le résultat, à vérifier

var_dump(1/2 + true); // 1/2 = 0.5 (donc float). Le booléen true est un type, 
// mais il correspond aussi à un int de valeur 1. Résultat : (float)1.5
...
// J'ai l'impression qu'il faudrait que je comprenne comment l'interpréteur fonctionne.

# 3) 
// Dans cette partie on fait du casting, c'est-à-dire qu'on force un type à adopter un autre type "provisoirement".
var_dump((bool) ""); // (bool)false. Je sais pas exactement pk mais ça me semble logique, un peu comme si la string est vide
...
var_dump((int) (25/7)); // (int)3 car on fait un cast.
var_dump(round(25/7)); // Après vérification, donne (float)4. J'imagine qu'il va au plus proche (25 % 7 = 4).
// Ainsi, le calcul sera 28 / 7 et non 21 / 7.
