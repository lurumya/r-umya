...
En effet, un homme et une femme sont des humains. Chacun à ces propres spécificités (le sexe par exemple) mais 
ils ont les deux des caractéristiques communes (un cerveau, 2 jambes, etc).
Autrement dit, la class "Homme" et la class "Femme" héritent des spécificités (attributs, méthodes, etc) de la class "mère" "Humain". 
Je vais donc pouvoir utiliser (j'hérite) les méthodes et les attributs contenus dans la class Humain. 
...
De plus, le paradigme de la POO est plus intuitif que d'autres paradigmes. 
